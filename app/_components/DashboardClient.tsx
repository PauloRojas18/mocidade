'use client'
// LOCALIZAÇÃO: app/_components/DashboardClient.tsx
// Client Component puro — só recebe props, sem useEffect, sem fetch, sem spinner
...
export default function DashboardClient({ jovens, cursos, praticas, freqDia, presAulas }: Props) {
